...
class home extends CI_Controller {
    ...
    public function project_details() {
        ...
        $data['projects'] = $this->apdm->get_home_project();
        $this->load->view('home/project_details', $data );
    }

    public function design_of_gas_plant() {
        $this->load->model('add_department_model', 'adm');
        $this->load->model('add_slider_model', 'asm');
        $data['data'] = $this->asm->get_slider();
        ...
        $this->load->model('add_institute_model', 'aim');
        $this->load->model('add_project_details_model', 'apdm');
        $data['projects'] = $this->apdm->get_home_gas_plant();
        $this->load->view('home/design_of_gas_plant', $data );
    }
    ...
    public function achievements() {
        ...
        $this->load->model('add_institute_model', 'aim');
        $this->load->model('add_project_details_model', 'apdm');
        $data['projects'] = $this->apdm->get_home_achievements();
        $this->load->view('home/achievements', $data );
    }

    public function project_organogram() {
        $this->load->model('add_department_model', 'adm');
        $this->load->model('add_slider_model', 'asm');
        $data['data'] = $this->asm->get_slider();
        ...
        $this->load->model('add_institute_model', 'aim');
        $this->load->model('add_project_details_model', 'apdm');
        $data['projects'] = $this->apdm->get_home_organogram();
        $this->load->view('home/project_organogram', $data );
    }
    ...
    public function project_area() {
        ...
        $this->load->model('add_institute_model', 'aim');
        $this->load->model('add_project_details_model', 'apdm');
        $data['projects'] = $this->apdm->get_home_project_area();
        $this->load->view('home/project_area', $data );
    }
    public function project_program_schedule() {
        $this->load->model('add_department_model', 'adm');
        $this->load->model('add_slider_model', 'asm');
        $data['data'] = $this->asm->get_slider();
        ...
        $this->load->model('add_institute_model', 'aim');
        $this->load->model('add_project_details_model', 'apdm');
        $data['projects'] = $this->apdm->get_home_program_schedule();
        $this->load->view('home/project_program_schedule', $data );
    }
    ...
    public function details($id){
        ...
        $this->load->model('add_project_details_model', 'apdm');
        $data['project'] = $this->apdm->get_project_id('project', $id);
    ...
    public function photo_gallery() {
        ...
        $this->load->view('home/photo_gallery', $data);
    }

	public function photo_gallery_details($id){
        ...
        $data['department'] = $this->db->get('department')->result();
		$this->load->model('add_photo_gallery_model', 'apgm');
		$data['photo_gallery'] = $this->apgm->get_photo_gallery_details('photo_gallery',$id);
        $this->load->view('home/photo_gallery_details', $data);
    }
