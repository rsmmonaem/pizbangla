...
class Page_model extends CI_Model
{
    ...
    function create_contact() {
        ...
        $this->form_validation->set_rules("user_email", "user_email", "xss_clean");
        $this->form_validation->set_rules("user_subject", "user_subject", "xss_clean");
        $this->form_validation->set_rules("user_message", "user_message", "xss_clean");
