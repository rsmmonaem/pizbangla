        ...
        <div class="container-fluid">
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <div class="btn-group">
                        <div>
                            <a href="<?= base_url() ?>super_admin/notice_list/" class="btn btn-info btn-lg tooltips"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="field-1" name="not_title"
                                                    required="">
                                            </div>
                                        </div>
