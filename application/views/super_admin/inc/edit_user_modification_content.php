        ...
        <div class="container-fluid">
            ...
            <div class="card m-b-30">
                ...
                <div class="card-body">
                    <div class="btn-group">
                        <div>
                            <a href="<?= base_url() ?>super_admin/user_modification_list/"
                                class="btn btn-info btn-lg tooltips" data-placement="top" data-toggle="tooltip"
                                data-original-title="Company List">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="field-1" name="full_name"
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="field-1" name="user_name"
                                                    value="<?= $data->user_name ?>" readonly="readonly">
                                            </div>
                                        </div>
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="field-1" class="control-label">Password</label>
                                                <input type="password" id="myInput" class="form-control" id="field-1"
                                                    name="pass_word" value="<?= $user_info->pass_word?>">
                                                <br>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="user_type" id="branch_dropdown">
                                                    ...
                                                    <option value="normal_user"
                                                        <?php if ($data->user_type == "normal_user"){echo "selected";} ?>>
                                                        User</option>
                                                    <option value="super_admin"
                                                        <?php if ($data->user_type == "super_admin"){echo "selected";} ?>>
                                                        Super Admin</option>
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="status" id="branch_dropdown">
                                                    <option value="" selected="" disabled="" hidden="">Select Here
                                                    </option>
                                                    <option value="ENABLE"
                                                        <?php if ($data->status == "ENABLE"){echo "selected";} ?>>Enable
                                                    </option>
                                                    <option value="DISABLE"
                                                        <?php if ($data->status == "DISABLE"){echo "selected";} ?>>
                                                        Disable</option>
                                                </select>
                                            </div>
                                        </div>
