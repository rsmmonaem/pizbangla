                        ...
                        <div class="card-body">
                            ...
                            <table id="datatable-buttons" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                ...
                                foreach ($data as $row):?>
                                    <tr>
                                        <td><?= $i++ ?></td>
                                        <td><?= character_limiter( $row->user_subject, 20) ?></td>
                                        <td><?=$row->user_name?></td>
                                        <td><?=$row->user_id?></td>
                                        <td><?=$row->user_email?></td>
                                        <td><?= character_limiter( $row->user_message, 30) ?></td>
                                        <td><?= date("d-m-Y", strtotime($row->date)) ?></td>
                                        <td>
                                            <button type="button" class="btn btn-success btn-round" data-toggle="modal" data-target="#modal-lg<?=$row->user_id  ?>">
                                                <i class="fa fa-eye"></i>
                                            </button>
                                            <div class="modal fade" id="modal-lg<?=$row->user_id  ?>">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="table-responsive">
                                                                <table class="table table-bordered mb-0">
																	...
																	<tr>
                                                                        <td width="30%">মেসেজদাতার আইডি</td>
                                                                        <td><?= $row->user_id ?></td>
                                                                    </tr>
                                                                    <tr>
