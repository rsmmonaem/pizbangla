<?php
		$dept=$this->adm->get_department();
		$inst = $this->aim->get_institute();
                                    ...
                                    <div id="information-part" class="content" role="tabpanel" aria-labelledby="information-part-trigger">
                                        ...
                                        <form action="<?= base_url() ?>institute_admin/save_trainee" method="post" enctype="multipart/form-data">
											...
											<div class="col-md-12">
												...
												<select class="form-control col-md-12 col-xs-12" name="inst_name" id="institute">
													<option value="">--Select--</option readonly>
													<?php foreach ($inst as $row) : ?>
														<?php if ($user_info->user_id === $row->inst_user_id) : ?>
															<option value="<?= $row->inst_name ?>" selected><?= $row->inst_name ?></option>
														<?php else : ?>
